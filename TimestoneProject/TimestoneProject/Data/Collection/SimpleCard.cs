namespace TimestoneProject.Data.Collection
{
    ...
    public class SimpleCard
    {
        ...
        private SimpleCard(string cardId, Enums.CardType cardType, Enums.CardSet cardSet, Enums.HeroClass heroClass, Enums.CardRarity rarity, string name, string text, int manaCost, int attack, int healthDurability, Enums.SpellType spellType)
        {
            Attack = attack;
            CardId = cardId;
            CardSet = cardSet;
        ...
        internal static SimpleCard MakeMinionCard(
            ...
            int health)
        {
            return new SimpleCard(cardId, Enums.CardType.Minion, cardSet, heroClass, rarity, name, text, manaCost, attack, health, Enums.SpellType.Default);
        }
        ...
        {
            return new SimpleCard(cardId, Enums.CardType.Minion, cardSet, heroClass, rarity, name, text, manaCost, 0, 0, spellType);
        }
        ...
        internal static SimpleCard MakeWeaponCard(
            ...
            int durability)
        {
            return new SimpleCard(cardId, Enums.CardType.Weapon, cardSet, heroClass, rarity, name, text, manaCost, attack, durability, Enums.SpellType.Default);
        }
